...
SerdNodeArgs
serd_as_token(const SerdNodeType type, const SerdStringView string)
{
...
SerdNodeArgs
serd_as_parsed_uri(const SerdURIView uri)
{
  SerdNodeArgs args;
...
SerdNodeArgs
serd_as_file_uri(const SerdStringView path, const SerdStringView hostname)
{
  SerdNodeArgs args;
...
SerdNodeArgs
serd_as_literal(const SerdStringView string,
...
SerdNodeArgs
serd_as_primitive(const SerdValue value)
{
  SerdNodeArgs args;
...
SerdNodeArgs
serd_as_decimal(const double value)
{
  SerdNodeArgs args;
...
SerdNodeArgs
serd_as_integer(const int64_t value)
{
  SerdNodeArgs args;
...
SerdNodeArgs
serd_as_hex(const size_t size, const void* const data)
{
  SerdNodeArgs args;
...
SerdNodeArgs
serd_as_base64(size_t size, const void* const data)
{
  SerdNodeArgs args;
