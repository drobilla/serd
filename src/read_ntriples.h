...
read_character(SerdReader* reader, TokenHeader* dest, uint8_t c);
...
*/
ZIX_NODISCARD SerdStatus
read_string_escape(SerdReader* reader, TokenHeader* ref);
...
*/
ZIX_NODISCARD SerdStatus
read_LANGTAG(SerdReader* reader, TokenHeader** dest);
...
*/
ZIX_NODISCARD SerdStatus
read_IRI(SerdReader* reader, TokenHeader** dest);
...
*/
ZIX_NODISCARD SerdStatus
read_IRIREF_suffix(SerdReader* reader, TokenHeader* node);
...
*/
ZIX_NODISCARD SerdStatus
read_STRING_LITERAL(SerdReader* reader, TokenHeader* ref, uint8_t q);
...
*/
ZIX_NODISCARD SerdStatus
read_BLANK_NODE_LABEL(SerdReader* reader, TokenHeader** dest, bool* ate_dot);
...
*/
ZIX_NODISCARD SerdStatus
read_UCHAR(SerdReader* reader, TokenHeader* node, uint32_t* code_point);
...
*/
ZIX_NODISCARD SerdStatus
read_ECHAR(SerdReader* reader, TokenHeader* dest);
...
*/
ZIX_NODISCARD SerdStatus
read_PN_CHARS_BASE(SerdReader* reader, TokenHeader* dest);
...
*/
ZIX_NODISCARD SerdStatus
read_PN_CHARS(SerdReader* reader, TokenHeader* dest);
...
*/
ZIX_NODISCARD SerdStatus
read_nt_subject(SerdReader* reader, TokenHeader** dest, bool* ate_dot);
...
*/
ZIX_NODISCARD SerdStatus
read_nt_predicate(SerdReader* reader, TokenHeader** dest);
...
*/
ZIX_NODISCARD SerdStatus
read_nt_object(SerdReader*   reader,
               TokenHeader** dest,
               TokenHeader** meta,
               bool*         ate_dot);
...
*/
ZIX_NODISCARD SerdStatus
read_Var(SerdReader* reader, TokenHeader** dest);
