...
serd_world_new(SerdAllocator* const allocator)
{
  ...
  if (!(world->rdf_first = serd_nodes_get(nodes, serd_as_uri(rdf_first))) ||
      !(world->rdf_nil = serd_nodes_get(nodes, serd_as_uri(rdf_nil))) ||
      !(world->rdf_rest = serd_nodes_get(nodes, serd_as_uri(rdf_rest))) ||
      !(world->rdf_type = serd_nodes_get(nodes, serd_as_uri(rdf_type))) ||
      !(world->xsd_boolean = serd_nodes_get(nodes, serd_as_uri(xsd_boolean))) ||
      !(world->xsd_decimal = serd_nodes_get(nodes, serd_as_uri(xsd_decimal))) ||
      !(world->xsd_integer = serd_nodes_get(nodes, serd_as_uri(xsd_integer)))) {
  ...
  serd_node_construct(sizeof(world->blank),
                      &world->blank,
                      serd_as_blank(serd_string("b00000000000")));
