...
{
  return (serd_node_matches(statement.subject, subject) &&
          serd_node_matches(statement.predicate, predicate) &&
          serd_node_matches(statement.object, object) &&
          serd_node_matches(statement.graph, graph));
}
