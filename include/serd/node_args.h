...
serd_a_null(void)
{
  return SERD_NODE_ARGS(SERD_NODE_ARGS_NODE_ID, 0U);
}
...
{
  return SERD_NODE_ARGS(SERD_NODE_ARGS_NODE_ID, id);
}
...
{
  return SERD_NODE_ARGS(SERD_NODE_ARGS_URI, .as_uri = uri);
}
...
{
  return SERD_NODE_ARGS(SERD_NODE_ARGS_HOST_PATH,
                        .as_string_pair = {hostname, path});
}
...
{
  return SERD_NODE_ARGS(SERD_NODE_ARGS_PREFIXED_NAME,
                        .as_string_pair = {prefix, name});
}
...
{
  return SERD_NODE_ARGS(SERD_NODE_ARGS_JOINED_URI,
                        .as_string_pair = {prefix, suffix});
}
...
{
  return SERD_NODE_ARGS(SERD_NODE_ARGS_TOKEN, .as_token = {type, string});
}
...
{
  return SERD_NODE_ARGS(SERD_NODE_ARGS_OBJECT,
                        .as_object = {type, string, flags, meta});
}
...
{
  return SERD_NODE_ARGS(SERD_NODE_ARGS_LITERAL,
                        .as_literal = {string, flags, meta});
}
...
{
  return SERD_NODE_ARGS(SERD_NODE_ARGS_VALUE, .as_value = value);
}
...
{
  return SERD_NODE_ARGS(SERD_NODE_ARGS_DECIMAL, .as_value = serd_double(value));
}
...
{
  return SERD_NODE_ARGS(SERD_NODE_ARGS_INTEGER, .as_value = serd_long(value));
}
...
{
  return SERD_NODE_ARGS(SERD_NODE_ARGS_HEX, .as_blob = {size, data});
}
...
{
  return SERD_NODE_ARGS(SERD_NODE_ARGS_BASE64, .as_blob = {size, data});
}
