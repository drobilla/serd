...
/**
   ...
   This sets up the reader to read from the given input.  This should be
   followed by serd_reader_read_chunk() or serd_reader_read_document() to
