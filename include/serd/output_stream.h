...
/**
   ...
   This is a general abstraction for a byte sink, for example a UTF-8 text file
   opened for writing.
*/
typedef struct {
...
/**
   ...
   @return An opened output stream, or all zeros on error.
*/
SERD_PURE_API SerdOutputStream
...
*/
SERD_API SerdStatus
serd_close_output(SerdOutputStream* ZIX_NONNULL output);
