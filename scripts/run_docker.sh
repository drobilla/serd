...
docker run -t -e MESON_TESTTHREADS=1 -e WINEPATH="Z:\\usr\\lib\\gcc\\i686-w64-mingw32\\8.3-win32;Z:\\workdir\\build\\subprojects\\exess;Z:\\workdir\\build\\subprojects\\rerex" -v $PWD:/workdir lv2plugin/debian-mingw32 ninja -C build test
...
docker run -t -e WINEPATH="Z:\\usr\\lib\\gcc\\i686-w64-mingw32\\8.3-win32;Z:\\workdir\\build\\subprojects\\exess;Z:\\workdir\\build\\subprojects\\rerex" -v $PWD:/workdir lv2plugin/debian-mingw32 ninja -C build test
...
docker run -t -e MESON_TESTTHREADS=1 -e WINEPATH="Z:\\usr\\lib\\gcc\\x86_64-w64-mingw32\\8.3-win32;Z:\\workdir\\build\\subprojects\\exess;Z:\\workdir\\build\\subprojects\\rerex" -v $PWD:/workdir lv2plugin/debian-mingw64 ninja -C build test
