...
test_field_supports(void)
{
  ...
  assert(serd_field_supports(SERD_SUBJECT, SERD_VARIABLE));
  ...
  assert(serd_field_supports(SERD_PREDICATE, SERD_VARIABLE));
  ...
  assert(serd_field_supports(SERD_OBJECT, SERD_VARIABLE));
  ...
  assert(serd_field_supports(SERD_GRAPH, SERD_VARIABLE));
}
