...
test_new(void)
{
  ...
  {
    SerdStatement* const statement = serd_statement_new(u, u, u, u, NULL);
    assert(statement);
  ...
  assert(!serd_statement_new(l, c, u, u, NULL));
  assert(!serd_statement_new(u, l, c, u, NULL));
  assert(!serd_statement_new(b, u, u, l, NULL));
