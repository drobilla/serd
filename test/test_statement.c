...
test_invalid_new(void)
{
  ...
  const SerdNode* const s = serd_nodes_get(nodes, serd_as_string("s"));

  const SerdNode* const u =
    serd_nodes_get(nodes, serd_as_uri_string(NS_EG "u"));

  const SerdNode* const b =
    serd_nodes_get(nodes, serd_as_blank(serd_string(NS_EG "b")));
...
test_copy(void)
{
  ...
  const SerdNode* const s =
    serd_nodes_get(nodes, serd_as_uri_string(NS_EG "s"));

  const SerdNode* const p =
    serd_nodes_get(nodes, serd_as_uri_string(NS_EG "p"));

  const SerdNode* const o =
    serd_nodes_get(nodes, serd_as_uri_string(NS_EG "o"));

  const SerdNode* const g =
    serd_nodes_get(nodes, serd_as_uri_string(NS_EG "g"));
...
test_copy_with_caret(void)
{
  ...
  const SerdNode* const f = serd_nodes_get(nodes, serd_as_string("file"));
