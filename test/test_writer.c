...
test_write_nested_anon(void)
{
  ...
  SerdNode* s0 =
    serd_node_new(NULL, serd_a_uri_string("http://example.org/s0"));
  SerdNode* p0 =
    serd_node_new(NULL, serd_a_uri_string("http://example.org/p0"));
  SerdNode* b0 = serd_node_new(NULL, serd_a_blank_string("b0"));
  SerdNode* p1 =
    serd_node_new(NULL, serd_a_uri_string("http://example.org/p1"));
  SerdNode* b1 = serd_node_new(NULL, serd_a_blank_string("b1"));
  SerdNode* p2 =
    serd_node_new(NULL, serd_a_uri_string("http://example.org/p2"));
  SerdNode* o2 =
    serd_node_new(NULL, serd_a_uri_string("http://example.org/o2"));
  SerdNode* p3 =
    serd_node_new(NULL, serd_a_uri_string("http://example.org/p3"));
  SerdNode* p4 =
    serd_node_new(NULL, serd_a_uri_string("http://example.org/p4"));
  SerdNode* o4 =
    serd_node_new(NULL, serd_a_uri_string("http://example.org/o4"));
...
test_write_error(void)
{
  ...
  SerdNode* const u =
    serd_node_new(NULL, serd_a_uri_string("http://example.com/u"));
...
test_write_empty_syntax(void)
{
  ...
  SerdNode* s = serd_node_new(NULL, serd_a_uri_string("http://example.org/s"));
  SerdNode* p = serd_node_new(NULL, serd_a_uri_string("http://example.org/p"));
  SerdNode* o = serd_node_new(NULL, serd_a_curie_string("eg:o"));
