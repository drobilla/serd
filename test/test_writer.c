...
test_write_nested_anon(void)
{
  ...
  const SerdNode* s0 =
    serd_nodes_get(nodes, serd_a_uri_string("http://example.org/s0"));
  const SerdNode* p0 =
    serd_nodes_get(nodes, serd_a_uri_string("http://example.org/p0"));
  const SerdNode* b0 = serd_nodes_get(nodes, serd_a_blank_string("b0"));
  const SerdNode* p1 =
    serd_nodes_get(nodes, serd_a_uri_string("http://example.org/p1"));
  const SerdNode* b1 = serd_nodes_get(nodes, serd_a_blank_string("b1"));
  const SerdNode* p2 =
    serd_nodes_get(nodes, serd_a_uri_string("http://example.org/p2"));
  const SerdNode* o2 =
    serd_nodes_get(nodes, serd_a_uri_string("http://example.org/o2"));
  const SerdNode* p3 =
    serd_nodes_get(nodes, serd_a_uri_string("http://example.org/p3"));
  const SerdNode* p4 =
    serd_nodes_get(nodes, serd_a_uri_string("http://example.org/p4"));
  const SerdNode* o4 =
    serd_nodes_get(nodes, serd_a_uri_string("http://example.org/o4"));
...
test_write_empty_syntax(void)
{
  ...
  const SerdNode* o = serd_nodes_get(nodes, serd_a_curie_string("eg:o"));
