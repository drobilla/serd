...
test(void)
{
  ...
  const SerdNode* s1 = serd_nodes_get(nodes, serd_as_string("s1"));
  const SerdNode* s2 = serd_nodes_get(nodes, serd_as_string("s2"));

  const SerdNode* rdf_first =
    serd_nodes_get(nodes, serd_as_uri_string(NS_RDF "first"));

  const SerdNode* rdf_value =
    serd_nodes_get(nodes, serd_as_uri_string(NS_RDF "value"));

  const SerdNode* rdf_rest =
    serd_nodes_get(nodes, serd_as_uri_string(NS_RDF "rest"));

  const SerdNode* rdf_nil =
    serd_nodes_get(nodes, serd_as_uri_string(NS_RDF "nil"));
