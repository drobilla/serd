...
test_comparison(void)
{
  ...
  const SerdNode* const a = serd_nodes_get(nodes, serd_a_uri_string(NS_EG "a"));
  const SerdNode* const b = serd_nodes_get(nodes, serd_a_uri_string(NS_EG "b"));
  const SerdNode* const c = serd_nodes_get(nodes, serd_a_uri_string(NS_EG "c"));
