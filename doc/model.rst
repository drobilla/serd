...
A new model can be created with :func:`serd_model_new`, which takes a default statement order, and a bitwise OR of flags:
...
the original document position is retained and available via  :func:`serd_cursor_get_caret`,
