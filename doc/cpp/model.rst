...
is returned by the :func:`~Model::all()` method:
...
A range of all statements with a specific ordering can be had via the :func:`~Model::ordered()` method:
