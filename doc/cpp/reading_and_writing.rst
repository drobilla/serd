...
This can be done by passing the sink returned by the writer's :func:`~Writer::sink` method to the :func:`reader constructor <Reader::Reader>`.
...
this can be done explicitly by calling its :func:`~ByteSink::close` method,
