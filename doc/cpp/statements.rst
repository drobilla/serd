...
Finally, a :class:`Cursor` may also be passed which records a position in the file that the statement was loaded from.
...
The cursor is also optional,
and can be accessed with the :func:`~StatementWrapper::cursor` method:
