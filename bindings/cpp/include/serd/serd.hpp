...
make_token(const NodeType type, StringView str)
{
  return Node{serd_node_new(
    nullptr, serd_as_token(static_cast<SerdNodeType>(type), str))};
}
...
{
  return Node{serd_node_new(nullptr, serd_as_string_view(str))};
}
...
{
  return Node{serd_node_new(nullptr, serd_as_uri(uri))};
}
...
{
  return Node{serd_node_new(nullptr, serd_as_parsed_uri(uri))};
}
...
make_uri(URI uri)
{
  return Node{serd_node_new(nullptr, serd_as_parsed_uri(*uri.cobj()))};
}
...
{
  return Node{
    serd_node_new(nullptr, serd_as_file_uri(path, serd_empty_string()))};
}
...
{
  return Node{serd_node_new(nullptr, serd_as_file_uri(path, hostname))};
}
...
{
  return Node{serd_node_new(
    nullptr, serd_as_literal(string, static_cast<SerdNodeFlags>(flags), meta))};
}
...
{
  return Node{serd_node_new(nullptr, serd_as_blank(str))};
}
...
{
  return Node{serd_node_new(nullptr, serd_as_plain_literal(str, lang))};
}
...
{
  return Node{serd_node_new(nullptr, serd_as_typed_literal(str, datatype))};
}
...
{
  return Node{serd_node_new(nullptr, serd_as_decimal(d))};
}
...
{
  return Node{serd_node_new(nullptr, serd_as_integer(i))};
}
...
{
  return Node{serd_node_new(nullptr, serd_as_base64(size, buf))};
}
...
/// Deleter for a Cursor wrapper
using CursorDeleter = detail::StandaloneDeleter<SerdCursor, serd_cursor_free>;

using CursorHandle = detail::
  Copyable<SerdCursor, CursorDeleter, serd_cursor_copy, serd_cursor_equals>;

/// @copydoc SerdCursor
class Cursor : public CursorHandle
{
public:
  explicit Cursor(const SerdCursor* const ptr)
    : CursorHandle{serd_cursor_copy(nullptr, ptr)}
  {}
  ...
  {
    _statement = StatementView{serd_cursor_get(cobj())};
    return _statement;
  }
...
public:
  ...
  */
  ...
  Cursor begin() const { return Cursor{serd_model_begin(cobj())}; }
