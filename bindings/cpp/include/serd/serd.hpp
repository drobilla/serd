...
enum class ModelFlag {
  store_graphs = SERD_MODEL_GRAPHS, ///< @copydoc SERD_MODEL_GRAPHS
  store_carets = SERD_MODEL_CARETS  ///< @copydoc SERD_MODEL_CARETS
};
