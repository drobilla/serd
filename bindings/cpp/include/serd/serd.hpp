...
/// Any wrapper for a #SerdCursor (const or mutable)
template<class CObj>
...
public:
  ...
  */
  ...
  Cursor begin() const
  {
    return Cursor(serd_model_begin(cobj()), detail::Ownership::owned);
  }
  ...
  {
    // TODO: cache?
    return Cursor(serd_cursor_copy(nullptr, serd_model_end(cobj())),
                  detail::Ownership::owned);
